                                ...
                                {data.map((value, index) => {
                                    <div data-index={index}>
                                        <tr style={{ lineHeight: "1.8em", boxSizing: "border-box", display: "table-row", verticalAlign: "inherit", borderColor: "inherit", width: "100%", fontFamily: "Roboto,sans-serif", borderCollapse: "separate", textIndent: "initial", borderSpacing: "2px", fontSize: ".8em", letterSpacing: "0", webkitTextSizeAdjust: "100%", height: "100%" }}>
                                            <td style={{ textAlign: "center", fontSize: "16px", padding: "10px 0", boxSizing: "border-box", display: "table-cell", verticalAlign: "inherit", lineHeight: "1.8em", width: "100%", fontFamily: "Roboto,sans-serif", borderCollapse: "separate", textIndent: "initial", borderSpacing: "2px", letterSpacing: "0", webkitTextSizeAdjust: "100%", height: "100%" }}>{value.position}</td>
                                            <td style={{ textAlign: "left", paddingLeft: "20px", fontSize: "16px", padding: "10px 0", boxSizing: "border-box", display: "table-cell", verticalAlign: "inherit", lineHeight: "1.8em", width: "100%", fontFamily: "Roboto,sans-serif", borderCollapse: "separate", textIndent: "initial", borderSpacing: "2px", letterSpacing: "0", webkitTextSizeAdjust: "100%", height: "100%" }}>
                                                <div class="flex" style={{ display: "flex", flex: "initial!important", boxSizing: "border-box", textAlign: "left", paddingLeft: "20px", fontSize: "16px", lineHeight: "1.8em", width: "100%", fontFamily: "Roboto,sans-serif", borderCollapse: "separate", textIndent: "initial", borderSpacing: "2px", letterSpacing: "0", webkitTextSizeAdjust: "100%", height: "100%" }}>
                                                    <div class="ipl-flag" style={{ background: "#2561AE", width: "40px", height: "22px", borderRadius: "4px", color: "#fff", fontWeight: "700", fontSize: "14px", textAlign: "center", display: "flex", justifyContent: "center", flexDirection: "column", marginRight: "10px", boxSizing: "border-box", paddingLeft: "20px", lineHeight: "1.8em", width: "100%", fontFamily: "Roboto,sans-serif", borderCollapse: "separate", textIndent: "initial", borderSpacing: "2px", letterSpacing: "0", webkitTextSizeAdjust: "100%", height: "100%" }}>{value.logo_character}</div>
                                                    <div style={{ boxSizing: "border-box", display: "block", textAlign: "left", paddingLeft: "20px", fontSize: "16px", lineHeight: "1.8em", width: "100%", fontFamily: "Roboto,sans-serif", borderCollapse: "separate", textIndent: "initial", borderSpacing: "2px", letterSpacing: "0", webkitTextSizeAdjust: "100%", height: "100%" }}>{value.short_name}</div>
                                                </div>
                                            </td>
                                            <td style={{ textAlign: "center", fontSize: "16px", padding: "10px 0", boxSizing: "border-box", display: "table-cell", verticalAlign: "inherit", lineHeight: "1.8em", width: "100%", fontFamily: "Roboto,sans-serif", borderCollapse: "separate", textIndent: "initial", borderSpacing: "2px", letterSpacing: "0", webkitTextSizeAdjust: "100%", height: "100%" }}>{value.net_rr}</td>
                                            <td style={{ textAlign: "center", fontSize: "16px", padding: "10px 0", boxSizing: "border-box", display: "table-cell", verticalAlign: "inherit", lineHeight: "1.8em", width: "100%", fontFamily: "Roboto,sans-serif", borderCollapse: "separate", textIndent: "initial", borderSpacing: "2px", letterSpacing: "0", webkitTextSizeAdjust: "100%", height: "100%" }}>{value.points}</td>
                                        </tr>
                                    </div>
                                })}
