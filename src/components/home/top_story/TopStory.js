                ...
                <section className={styles.homepageWrapper}>
                    <div className={styles.mastheadWrapper}>
                        <div className={styles.homepageShadow}>
                            ...
                            {this.state.latestStories.slice(1).map((item, index) => <TopStorySmallCard story={item} height="79px"></TopStorySmallCard>)}
                            {this.state.topStories.slice(0, 3).map((item, index) => <TopStorySmallCard story={item} height="79px"></TopStorySmallCard>)}
                        </div>
                        <div className={styles.homepageShadow}>
                            <div className="cardContainer">
                            ...
                            {this.state.topStories.slice(4, 10).map((item, index) => <TopStorySmallCard story={item} height="58px"></TopStorySmallCard>)}
                        </div>
                        <div></div>
                    </div>
                </section>
