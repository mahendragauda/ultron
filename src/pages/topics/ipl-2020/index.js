    ...
    return (
        <>
            ...
            <nav id="breadcrumb" className={[styles.font14, styles.fontRoboto, styles.font14 ,styles.flex ,styles.flexAlignItemsCenter].join(" ")} style={{ paddingTop: "15px", paddingLeft: "10px", paddingRight: "10px" }}>
                ...
                <span className={styles.txtTransformCaps}><Link href="/"><a style={{ textDecoration: "underline !important", color: "#e60000", fontWeight: "500!important" }}> IPL 2020</a></Link></span>
            </nav>
            ...
            <div className={[styles.padtop20, styles.flex ,styles.cricketPageResponsive].join(" ")} style={{ padding: "20px 10px 10px 10px", flexDirection: "column" }}>
                <div className={[styles.fxWidth67, styles.width67, styles.cricketPageResponsive].join(" ")}>
                    <div className={styles.flex} style={{ display: "flex", flex: "initial!important", webkitBoxSizing: "border-box", fontFamily: "Roboto,sans-serif" }}>
                    ...
                    <div className={[styles.clrD10014, styles.mrgntop10, styles.pad5, styles.font18, styles.bdr4pxDddddd, styles.fontweight700].join(" ")}>
                        Disclaimer: None of the advertisers on this page are the official sponsors of the IPL 2020
                    </div>
                </div>
