                    ...
                    case 'schedule.html':
                        return <>
                            <div style={{ marginTop: "20px!important", boxSizing: "border-box", display: "block", fontFamily: "Roboto,sans-serif", fontSize: ".8em" }}>
                                ...
                                <div style={{ padding: "10px 10px", flex: "initial!important", boxSizing: "border-box", fontFamily: "Roboto,sans-serif", fontSize: ".8em", letterSpacing: "0", lineHeight: "20px", height: "100%" }}>
                                                ...
                                                <a href="https://www.republicworld.com/cricket/ipl-2021/hyderabad-vs-mumbai-live-score/iplt20-2021-g31.html" style={{ textDecoration: "none!important", border: "none", color: "#000", fontFamily: "Roboto,sans-serif", }}>
                                                    ...
                                                    <div style={{ paddingTop: "15px", justifyContent: "space-between", display: "flex", flex: "initial!important", textDecoration: "none!important", border: "none", color: "#000", fontFamily: "Roboto,sans-serif", }}>
                                                        <div class="flex" style={{ display: "flex", flex: "initial!important", textDecoration: "none!important", border: "none", color: "#000", fontFamily: "Roboto,sans-serif", }}>
                                                            <div class="schedule-team-flag" style={{ background: "#004BA0", width: "45px", height: "32px", boxShadow: "0 0 2px 2px #00000007", borderRadius: "2px", color: "#fff", fontSize: "20px", textAlign: "center", display: "flex", justifyContent: "center", flexDirection: "column" }}>{value.teams.a.logo_character}</div>
                                                        ...
                                                        <div class="flex" style={{ display: "flex", flex: "initial!important", textDecoration: "none!important", border: "none", color: "#000", fontFamily: "Roboto,sans-serif", }}>
                                                            ...
                                                            <div class="schedule-team-flag" style={{ background: "#004BA0", width: "45px", height: "32px", boxShadow: "0 0 2px 2px #00000007", borderRadius: "2px", color: "#fff", fontSize: "20px", textAlign: "center", display: "flex", justifyContent: "center", flexDirection: "column" }}>{value.teams.b.logo_character}</div>
                                                        </div>
                                                    </div>
                                ...
                                <div style={{ marginTop: "30px", lineHeight: "20px" }}>
                                    ...
                                    <div style={{ flexWrap: "wrap", WebkitBoxSizing: "border-box", padding: "10px" }}>
                                        {cricketStories.data.stories.slice(0, 6).map((value, index) => {
                                            return (
                                                <div data-index={index = 5}>
                                                    <article style={{ marginRight: "20px", maxWidth: "48.68%", padding: "10px", marginBottom: "10px", borderRadius: "4px", flex: "1 1 48%", border: "1px solid #ddd", WebkitBoxSizing: "border-box" }}>
                                                        <Link href="">
                                                            <a style={{ textDecoration: "none!important", border: "none", color: "#000", WebkitBoxSizing: "border-box" }}>
                                                                <div style={{ flexDirection: "column", display: "flex", flex: "initial!important", WebkitBoxSizing: "border-box" }}>
                                                                    <div style={{ height: "60px", WebkitBoxSizing: "border-box", textDecoration: "none!important", border: "none", color: "#000" }}>
                                                                        <p style={{ fontSize: "16px", fontWeight: "400", margin: "0!important", WebkitLineClamp: "3!important", overflow: "hidden", display: "-webkit-box", webkitBoxOrient: "vertical", WebkitBoxSizing: "border-box", marginBlockStart: "1em", marginBlockEnd: "1em", marginInlineStart: "0px", marginInlineEnd: "0px" }}>
                                                                            {value.meta_title}
                                                                        </p>
                                                                    </div>
                                                                    <div style={{ paddingTop: "5px", WebkitBoxSizing: "border-box" }}>
                                                                        <p style={{ fontSize: "14px", color: "#464646", margin: "0", WebkitBoxSizing: "border-box", display: "block", marginBlockStart: "1em", marginBlockEnd: "1em", marginInlineStart: "0px", marginInlineEnd: "0px" }}>{value.pub_datetime}</p>
                                                                    </div>
                                                                </div>
                                                            </a>
                                                        </Link>
